...
parser.add_argument('--filename', type=str, default="0", help='filename')
parser.add_argument('--prompt', type=str, default="Lovely white fondant-covered cake with a purple ribbon", help='prompt')
...
print(f'image {filename} saved successfully in {base_folder}/{sub_folders[0]}/{filename}_{args.seed}.')
